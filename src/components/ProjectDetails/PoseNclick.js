...
import header from '../../assets/details/HomePose.png'
import fullpic from '../../assets/details/posepafe.png'
import adminDashboard from '../../assets/details/addServicePose.png'
import BuyerDashboard from '../../assets/details/servicesPose.png'
        ...
        <section id='laptop-bazar' className='text-white'>
            ...
            <div className=' p-4 md:p-20 md:mb-48'>
                <h1 className='text-xl text-info my-5 font-bold'>Some section :</h1>
                 ...
                 <div className='my-16 md:my-20'>
                      <h1 className='text-gray-400 text-2xl md:text-5xl font-bold text-right '>Services</h1>
